...
import { addNewRole } from '../../../../services/adminService';
// import { ad } from '../../../../services/adminService';
...
const RoleAddModal = (props) => {
    ...
    const addRole = () => {
        addNewRole(rolesValue).then(function(response) {
            props.setOpen(false)
            let newArray = [...roles?.roles]
            newArray.push(response?.role)
                                    ...
                                    <Transition.Child as={Fragment} enter="ease-in-out duration-500" enterFrom="opacity-0" enterTo="opacity-100" leave="ease-in-out duration-500" leaveFrom="opacity-100" leaveTo="opacity-0">
                                        <div className="flex h-full flex-col  overflow-y-scroll bg-white py-6 shadow-xl">
                                            ...
                                            <div className="ml-auto relative mt-6 px-4 sm:px-6">
                                                ...
                                                <button onClick={(e) => addRole()} className=" bg-blue-600 px-3 py-2 rounded-lg text-white text-sm font-semibold" >Save</button>
                                            </div>
