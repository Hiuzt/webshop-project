...
const RoleAction = (props) => {
    ...
    return (
        <>
                ...
                <RoleDeleteModal isOpen = {isDeleteOpen} setOpen = {setDeleteOpen} roleIndex = {props.roleIndex} />
                <RoleEditModal isOpen = {isEditOpen} setOpen = {setEditOpen} roleIndex = {props.roleIndex}/>
